...
export default function CreatePage() {
    ...
    return (<>
        ...
        <Grid container sx={{width:"100%"}}>
            <Grid item xs={2} />
            <Grid item xs={8}>     
            <Stack alignItems="center" direction="column" justifyContent="center" justifyItems="center" marginTop={10}>
            <Box sx={{width:"100%"}}>
            <Paper variant="elevation" sx={{p:2, mt:1, mb:0, backgroundColor:"primary.light", color:"primary.contrastText"}} square>
            <Typography variant="nav" fontSize={30}>Create New Statblock</Typography>
            </Paper>

            <Paper variant="elevation" square
                    sx={{width:"100%", p:1, m:0, height:"100%"}}>
                <Grid container spacing={1}>
                <Grid item xs={12}>
